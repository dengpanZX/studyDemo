...
import com.zxxk.kg.listview_test.listview.MyListViewPullDown_NoRefresh;
import com.zxxk.kg.listview_test.listview.MyListViewPullDown_NoRefresh.OnRefreshListener;
 ...
 *
 */
public class ListViewPullDown_NoRefreshActivity extends Activity {
	
    private MyListViewPullDown_NoRefresh listView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listpulldown_norefresh);
        
        listView=(MyListViewPullDown_NoRefresh)findViewById(R.mainactivity.freelook_listview);
...
//    					data.add("刷新后添加的内容");
    ...
    private class listViewAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View view=LayoutInflater.from(ListViewPullDown_NoRefreshActivity.this).inflate(R.layout.item_new, null);
